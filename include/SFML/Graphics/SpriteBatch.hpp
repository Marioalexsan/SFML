...
#ifndef SFML_SPRITEBATCH_HPP
#define SFML_SPRITEBATCH_HPP
...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    void batch(const Batchable& drawable, float depth = 0.0f);
...
private:
    ...
    struct TriangleInfo
    {
        const Texture* texture = nullptr; //!< The triangle's texture
        float          depth   = 0.0f;    //!< The depth of the triangle
    ...
    struct BatchInfo
    {
        const Texture* texture     = nullptr; //!< The texture used to render the batch
        std::size_t    vertexCount = 0;       //!< The number of contiguous vertices to render
